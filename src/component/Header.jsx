                ...
                <header className="w-full mt-5 text-gray-700 bg-white shadow-sm body-font">
                    <div className="container flex flex-col items-start p-6 mx-auto md:flex-row">
                        ...
                        <nav className="flex items-center justify-center text-base md:ml-auto">
                            ...
                            <a href="#_" className="mr-5 font-medium hover:text-gray-900">Course</a>
                            <a href="#_" className="mr-5 font-medium hover:text-gray-900">Contact</a>
                            <a href="#_" className="font-medium hover:text-gray-900">Events</a>
                        </nav>
                        <div className="items-center h-full pl-6 ml-6 border-l border-gray-200">
                            <a href="#_" className="px-4 py-2 text-xs font-bold text-white uppercase transition-all duration-150 bg-teal-500 rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease">
                            study area
                            </a>
                            <a href="#_" className="mr-5 ml-5 font-medium hover:text-gray-900">Login</a>
                            <a href="#_" className="px-4 py-2 text-xs font-bold text-white uppercase transition-all duration-150 bg-teal-500 rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease">
                                Sign Up
                            </a>
                        </div>
